...
def create_bt_poses(hwf):
    ...
    max_trans = max_disp / hwf[
        2]  # self.targets['K_src'][0, 0, 0]  # Maximum camera translation to satisfy max_disp parameter
...
def render_wander_path(c2w):
    ...
    max_trans = max_disp / hwf[2][
        0]  # self.targets['K_src'][0, 0, 0]  # Maximum camera translation to satisfy max_disp parameter
    output_poses = []
